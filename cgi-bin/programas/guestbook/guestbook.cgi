#!/usr/bin/perl
# Programa adaptado por elserver.com
##############################################################################
...
$guestbookurl	= "http://oajnu.org/programas/guestbook/guestbook.htm";
$guestbookreal	= "/www/oajnu.org/htdocs/programas/guestbook/guestbook.htm";
$guestlog	= "/www/oajnu.org/htdocs/programas/guestbook/log.htm";
$cgiurl		= "http://oajnu.org/cgi-bin/programas/guestbook/guestbook.cgi";
...
for ($i=0;$i<=$SIZE;$i++) {
   ...
   if (/<!--begin-->/) { 
      ...
      print GUEST "<p><b>$FORM{'comments'}</b><br>\n";
...
if ($mail eq '1') {
   ...
   print MAIL "Subject: Nueva firma en tu libro de visitas\n\n";
   print MAIL "Tienes un nuevo registro en tu libro de visitas!:\n\n";
   print MAIL "------------------------------------------------------\n";
...
if ($remote_mail eq '1' && $FORM{'username'}) {
   ...
   print MAIL "Subject: Firma en oajnu.org\n\n";
   print MAIL "Muchas gracias por tu firma.\n\n";
   print MAIL "------------------------------------------------------\n";
   print MAIL "$FORM{'comments'}\n";
   print MAIL "$FORM{'realname'}";
...
sub no_comments {
   ...
   print "{ font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8pt; color: #000000 }\n";
   print "p {  font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8pt; color: #000000 }\n";
   print "td { font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8pt; color: #000000 }\n";
   print "a {  font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8pt; color: #000099 }\n";
   print "a:hover {  color: #FF0000}\n";
   print "-->\n</style>\n";
   print "<title>Faltan datos</title>\n</head>\n";
   print "<body><h1>Debe completar sus comentarios</h1>\n";
   print "<form method=POST action=\"$cgiurl\">\n";
   print "Nombre:<input type=text name=\"realname\" size=30 ";
   print "value=\"$FORM{'realname'}\"><br>\n";
   print "E-Mail: <input type=text name=\"username\""; 
   print "value=\"$FORM{'username'}\" size=40><br>\n";
   print "Ciudad: <input type=text name=\"city\" value=\"$FORM{'city'}\" ";
   print "size=15> País: <input type=text "; 
   print "name=\"country\" value=\"$FORM{'country'}\" size=15><p>\n";
   print "Comentario:<br>\n";
   print "<textarea name=\"comments\" COLS=60 ROWS=4></textarea><p>\n";
   print "<input type=submit value=\"Publicar\"></form><hr>\n";
   print "Volver al <a href=\"$guestbookurl\">Guestbook</a>.";
   print "\n</body></html>\n";
...
sub no_name {
   ...
   print "-->\n</style>\n";
   print "<title>Faltan datos</title>\n</head>\n";
   print "<body><h1>Debe completar su nombre</h1>\n";
   print "<form method=POST action=\"$cgiurl\">\n";
   print "Nombre:<input type=text name=\"realname\" size=30><br>\n";
   print "E-Mail: <input type=text name=\"username\"";
   print " value=\"$FORM{'username'}\" size=40><br>\n";
   print "Ciudad: <input type=text name=\"city\" value=\"$FORM{'city'}\" ";
   print "size=15> País: <input type=text ";
   ...
   print "size=15><p>\n";
   print "Los comentarios ya están almacenados.<p>\n";
   print "<input type=hidden name=\"comments\" ";
   print "value=\"$FORM{'comments'}\">\n";
   print "<input type=submit value=\"Publicar\"> <hr>\n";
   print "Volver al <a href=\"$guestbookurl\">Guestbook</a>.";
   print "\n</body></html>\n";
...
sub no_redirection {
   ...
   print "<body><h1>Gracias por publicar su mensaje</h1>\n";

   # Print Response
   print "Esto es lo que publicó:<p>\n";
   ...
   # Print End of HTML
   print "<hr>\n";
   print "<a href=\"$guestbookurl\">Volver al guestbook</a>\n";         print "- Pueda que deba actualizar la página para ver el nuevo mensaje\n";
   print "</body></html>\n";
